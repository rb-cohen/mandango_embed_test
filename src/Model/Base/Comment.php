 ...
 */
abstract class Comment extends \Mandango\Document\EmbeddedDocument
{
    /**
    ...
    public function setText($value)
    {
        if (!isset($this->data['fields']['text'])) {
            if (($rap = $this->getRootAndPath()) && !$rap['root']->isNew()) {
                $this->getText();
                if ($this->isFieldEqualTo('text', $value)) {
                    return $this;
                }
            } else {
                if (null === $value) {
        ...
        } elseif ($this->isFieldEqualTo('text', $value)) {
            return $this;
        }
        ...
        } elseif ($this->isFieldModifiedEqualTo('text', $value)) {
